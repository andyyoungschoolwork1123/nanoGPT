...
if __name__ == '__main__':
    ...
    csv = load_and_concatenate_csvs("data\\stock_dat\\clean\\")
    dataset = load_dataset("csv", data_files='alldata.csv' )
    ...
    def process(example):
        ids = enc.encode_ordinary(example['close']) # encode_ordinary ignores any special tokens
